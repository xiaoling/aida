 ...
 * AIDA. 
 */
public class FastCocktailPartyDisambiguationSettings extends DisambiguationSettings {
  ...
  public FastCocktailPartyDisambiguationSettings() throws MissingSettingException {
    ...
    switchedKPsettings.setMaxEntityKeyphraseCount(1000);
    switchedKPsettings.setMinimumEntityKeyphraseWeight(0.001);
