...
public class Token implements Serializable {
  ...
  public Token(int standfordTokenId, String original, String originalEnd, int beginIndex, int endIndex, int sentence, int paragraph, String pos, String ne) {
    this.standfordTokenId = standfordTokenId;
    this.original = original;
  ...
  public String toString() {
    return standfordTokenId + " :: " + getOriginal() + " :: " + ne + " / " + ptag + " / " + lemma + " (" + beginIndex + "," + endIndex + ";" + length + ") " + " {" + sentence + "/" + paragraph + "}";
  }

  public String toHtmlString() {
    return "<th><a name = token" + standfordTokenId + ">" + standfordTokenId + "</a></th><th>" + "<b><a href=\"#text" + standfordTokenId + "\" STYLE=\"color:#000000;text-decoration:none\">" + Char.toHTML(getOriginal()) + "</a></b></th><th>" + ne + " / " + ptag
        + "</th><th>" + beginIndex + " / " + endIndex + " / " + length + "</th><th>" + sentence + " / " + paragraph + "" + "</th>";
  }
